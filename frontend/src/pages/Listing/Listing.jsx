    ...
    return (
        <div className='relative'>
            ...
            <div className='flex flex-col gap-5 top-36'>
                <div className='relative'>
                    <img src={header} className='w-full h-full lg:h-[300px] object-cover  ' />
                ...
                <div className='text-white absolute text-center py-5 sm:py-10 md:py-14 xl:py-20 px-12 md:px-36 lg:px-52'>
                    <h1 className='text-md sm:text-2xl md:text-4xl font-bold uppercase mb-1 sm:mb-5'>Listing</h1>
            ...
            <div className='m-5 p-5  sm:m-10 sm:p-10 shadow-lg bg-white -mt-8 sm:-mt-14 z-10 relative'>
                <div className="text-secondary text-lg sm:text-2xl font-semibold uppercase leading-[33.60px] tracking-tight mb-5">LIST OF PRODUCTS</div>
                        ...
                        stars?.items?.map((star) => {
                            return (
                                <tr className="hover:bg-accent cursor-pointer">
                                    ...
                                    <td className="px-4 py-3">
                                        <Button className='rounded-lg px-1'>
                                            View Details
                                        </Button>
                                    </td>
                                </tr>
