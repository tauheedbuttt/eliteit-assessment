        ...
        <div >
            ...
            <div className='flex flex-col gap-5 top-36'>
                <div className='relative'>
                    <img src={header} className='w-full h-full lg:h-[300px] object-cover rounded-bl-[100%] rounded-br-[100%]' />
                    <div className='bg-secondary inset-0  absolute w-full h-full opacity-50 rounded-bl-[100%] rounded-br-[100%]' />
                </div>
                <div className='text-white absolute text-center py-5 sm:py-10 md:py-14 xl:py-20 px-12 md:px-36 lg:px-52'>
                    <h1 className='text-md sm:text-2xl md:text-4xl font-bold uppercase mb-1 sm:mb-5'>Solutions that Inspire, Products that Deliver</h1>
                    <p className='text-[8px] sm:text-[10px] md:text-sm opacity-80'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur tellus neque, malesuada sit amet auctor ac, euismod sed enim. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Donec sed ultricies libero. Morbi porttitor semper nibh, bibendum ultricies elit mollis id.</p>
                </div>
            </div>
